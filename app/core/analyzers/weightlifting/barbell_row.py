...
class BarbellRowAnalyzer(BaseLiftAnalyzer):
    async def analyze(self, pose_data: List[Dict]) -> AnalysisResult:
        ...
        depth_score, depth_metric, depth_feedback = self.analyze_depth(landmarks_list, 0.4)
        ...
        hip_score, hip_metric, hip_feedback = self.analyze_joint_angles(angles_list, "left_hip", 100.0, 25.0)
